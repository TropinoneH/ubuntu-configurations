...
# PATH
export PATH=$CARGO_HOME/bin:$GOROOT/bin:$DOTNET_PATH:"$HOME/miniconda3/bin":$CUDA_HOME/bin:/usr/local/applications/Qt/6.6.0/gcc_64/bin:/usr/local/applications/jetbrains/clion/bin/cmake/linux/x64/bin:$PATH
...
__conda_setup="$('/home/mspt5/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/mspt5/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/mspt5/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/mspt5/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
